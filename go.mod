module github.com/mshore-dev/caddy-tailscale

go 1.24.0

toolchain go1.24.1

replace github.com/tailscale/caddy-tailscale => .
...
require (
	...
	github.com/tailscale/golang-x-crypto v0.0.0-20250404221719-a5573b049869 // indirect
